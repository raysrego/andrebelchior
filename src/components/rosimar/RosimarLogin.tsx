...
export default function RosimarLogin({ onLogin }: Props) {
      ...
      <div className="relative w-full max-w-sm">
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-slate-800 px-8 pt-10 pb-8 text-center">
            ...
            <h1 className="text-xl font-bold text-white leading-tight">Rosimar</h1>
            <p className="text-slate-400 text-sm mt-1">Controle de Pagamentos</p>
          </div>
          ...
          <div className="px-8 pb-6 text-center">
            <p className="text-xs text-slate-300">Rosimar v1.0</p>
          </div>
        </div>
      </div>
    </div>
